  ...
  function renderTrend(canvasId, monthly) {
    ...
    charts[canvasId] = new Chart(el, {
      data: {
        ...
        datasets: [
          { type: "bar", label: "매출", data: monthly.map((r) => r.sales), backgroundColor: "#8fb3e0", borderRadius: 4, maxBarThickness: 26 },
          { type: "bar", label: "매입", data: monthly.map((r) => r.purchase), backgroundColor: "#c8cfdb", borderRadius: 4, maxBarThickness: 26 },
          { type: "line", label: "손익", data: monthly.map((r) => r.profit), borderColor: "#7fc5be", backgroundColor: "#7fc5be", tension: .3 },
        ],
      },
